...
<head>
  ...
  <title>Login - Marquinhos veiculos</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Login com sua conta</h5>
                    <p class="text-center small">Digite o usuário e senha</p>
                  </div>

                  <form class="row g-3 needs-validation" method = "POST" action = "http://127.0.0.1/codeigniter-aula/index.php/login/validalogin">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Não possui cadastro? <a href="pages-register.html">Crie sua conta</a></p>
                    </div>
                  </form>
